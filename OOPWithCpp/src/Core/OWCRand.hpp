...
namespace OWC::Rand
{
	...
	{
		static thread_local std::array<u64, 4> stats = { 123456789u, 362436069u, 521288629u, 88675123u };
...
//		stats[0] = temp ^ s ^ (s >> 19);
	...
	OWC_FORCE_INLINE Vec4 LinearFastRandVec4(const Vec4& min, const Vec4& max)
	{
		...
		static thread_local std::array<Vec4u32, 4> states = {
			Vec4u32{ 123456789u, 362436069u, 521288629u, 88675123u },
			Vec4u32{ 5783321u, 6615241u, 1234567u, 89101112u },
			Vec4u32{ 42424242u, 42424243u, 42424244u, 42424245u },
			Vec4u32{ 987654321u, 123456789u, 192837465u, 564738291u }
		};

		Vec4u32 temp = states[3];
